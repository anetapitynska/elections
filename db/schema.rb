...
ActiveRecord::Schema.define(version: 20150216214932) do
  ...
  add_index "commitees", ["voivodeship_id"], name: "index_commitees_on_voivodeship_id"
  ...
  add_index "commitees_voivodeships", ["commitee_id", "voivodeship_id"], name: "commitees_voivodeships_index", unique: true
